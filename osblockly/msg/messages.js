...
Blockly.Msg.OSBOT_RJ25_NAME = 'RJ25';
Blockly.Msg.OSBOT_BZ_TITLE = 'BzSensor';
Blockly.Msg.OSBOT_XJ_TITLE = 'XjSensor';
Blockly.Msg.OSBOT_LEFT_NAME = 'Left';
Blockly.Msg.OSBOT_RIGHT_NAME = 'Right';
Blockly.Msg.OSBOT_FACE_TITLE = 'BotFace';
Blockly.Msg.OSBOT_EYE_NAME = 'Eye';
Blockly.Msg.OSBOT_MOUTH_NAME = 'Mouth';
Blockly.Msg.OSBOT_ICON_NAME = 'ICON';
Blockly.Msg.OSBOT_TEXTOUT_TITLE = 'TextOut';
Blockly.Msg.OSBOT_TEXTOUT_CONTENT_NAME = 'Content';
Blockly.Msg.OSBOT_MOTOR_TITLE = 'Motor';
Blockly.Msg.OSBOT_MOTOR_DIRECTION_NAME = 'Direction';
Blockly.Msg.OSBOT_MOTOR_SPEED_NAME = 'Speed';
Blockly.Msg.OSBOT_CLOCKWISE_NAME = 'Clockwise';
Blockly.Msg.OSBOT_ANTICLOCKWISE_NAME = 'AntiClockwise';
Blockly.Msg.OSBOT_DELAY_TITLE = 'Delay';
Blockly.Msg.OSBOT_DELAY_UNIT_NAME = 'Milliseconds';
Blockly.Msg.OSBOT_VOICE_TITLE = 'Voice';
Blockly.Msg.OSBOT_TRACK_NAME = 'Track';
Blockly.Msg.OSBOT_VOLUME_NAME = 'Volume';