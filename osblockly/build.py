...
#socks.setdefaultproxy(socks.PROXY_TYPE_SOCKS5, "127.0.0.1", 20001)
...
class Gen_compressed(threading.Thread):
  ...
  def run(self):
    ...
    #self.gen_generator("osbot")
    #self.gen_generator("python")
    #self.gen_generator("php")
    #self.gen_generator("dart")
    
  def gen_utils(self):
    target_filename = "utils_compressed.js"
    ...
    filenames = glob.glob(os.path.join("utils", "*.js"))
